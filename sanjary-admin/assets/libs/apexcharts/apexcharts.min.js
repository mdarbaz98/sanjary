  ...
  function g(t) {
    return (
      ...
      (function (t, e) {
        ...
        if (
          "Arguments" === i ||
          /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?ArrayINR/.test(i)
        )
          return u(t, e);
      })(t) ||
      (function () {
        ...
        a(
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                return parseFloat(t.replace(/^.*,(.+)\)/, "INR1"));
              },
            },
            {
              key: "rgb2hex",
            ...
            },
            {
              key: "isColorHex",
              value: function (t) {
                return /(^#[0-9A-F]{6}INR)|(^#[0-9A-F]{3}INR)|(^#[0-9A-F]{8}INR)/i.test(
                  t
                );
              },
            },
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e = (e = (e = e.replace(/(^|[^\\])yyyy+/g, "INR1" + h)).replace(
                /(^|[^\\])yy/g,
                "INR1" + h.toString().substr(2, 2)
              )).replace(/(^|[^\\])y/g, "INR1" + h);
              var c = (a ? t.getUTCMonth() : t.getMonth()) + 1;
              e = (e = (e = (e = e.replace(
                /(^|[^\\])MMMM+/g,
                "INR1" + s[0]
              )).replace(/(^|[^\\])MMM/g, "INR1" + r[0])).replace(
                /(^|[^\\])MM/g,
                "INR1" + l(c)
              )).replace(/(^|[^\\])M/g, "INR1" + c);
              ...
              e = (e = (e = (e = e.replace(
                /(^|[^\\])dddd+/g,
                "INR1" + n[0]
              )).replace(/(^|[^\\])ddd/g, "INR1" + o[0])).replace(
                /(^|[^\\])dd/g,
                "INR1" + l(d)
              )).replace(/(^|[^\\])d/g, "INR1" + d);
              ...
              e = (e = (e = (e = e.replace(
                /(^|[^\\])HH+/g,
                "INR1" + l(u)
              )).replace(/(^|[^\\])H/g, "INR1" + u)).replace(
                /(^|[^\\])hh+/g,
                "INR1" + l(f)
              )).replace(/(^|[^\\])h/g, "INR1" + f);
              var p = a ? t.getUTCMinutes() : t.getMinutes();
              e = (e = e.replace(/(^|[^\\])mm+/g, "INR1" + l(p))).replace(
                /(^|[^\\])m/g,
                "INR1" + p
              );
              var x = a ? t.getUTCSeconds() : t.getSeconds();
              e = (e = e.replace(/(^|[^\\])ss+/g, "INR1" + l(x))).replace(
                /(^|[^\\])s/g,
                "INR1" + x
              );
              var b = a ? t.getUTCMilliseconds() : t.getMilliseconds();
              (e = e.replace(/(^|[^\\])fff+/g, "INR1" + l(b, 3))),
                (b = Math.round(b / 10)),
                (e = e.replace(/(^|[^\\])ff/g, "INR1" + l(b))),
                (b = Math.round(b / 10));
              var m = u < 12 ? "AM" : "PM";
              e = (e = (e = e.replace(/(^|[^\\])f/g, "INR1" + b)).replace(
                /(^|[^\\])TT+/g,
                "INR1" + m
              )).replace(/(^|[^\\])T/g, "INR1" + m.charAt(0));
              var v = m.toLowerCase();
              e = (e = e.replace(/(^|[^\\])tt+/g, "INR1" + v)).replace(
                /(^|[^\\])t/g,
                "INR1" + v.charAt(0)
              );
              ...
              return (e = (e = (e = (e = (e = e.replace(
                ...
                new RegExp(s[0], "g"),
                s[c]
              )).replace(new RegExp(r[0], "g"), r[c])).replace(/\\(.)/g, "INR1"));
            },
          },
          {
  ...
  (Tt = "undefined" != typeof window ? window : void 0),
    (zt = function (e, i) {
      ...
      (a.did = 1e3),
        ...
        (a.regex = {
          numberAndUnit: /^([+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?)([a-z%]*)INR/i,
          hex: /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})INR/i,
          rgb: /rgb\((\d+),(\d+),(\d+)\)/,
          reference: /#([a-z0-9\-_]+)/i,
          transforms: /\)\s*,?\s*/,
          whitespace: /\s/g,
          isHex: /^#[a-f0-9]{3,6}INR/i,
          isRgb: /^rgb\(/,
          isCss: /[^:]+:[^;]+;?/,
          isBlank: /^(\s+)?INR/,
          isNumber: /^[+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?INR/i,
          isPercent: /^-?[\d\.]+%INR/,
            ...
            t =
              "string" == typeof t
                ? t
                    ...
                    .replace(a.regex.pathLetters, " INR& ")
                    .replace(a.regex.hyphen, "INR1 -")
                    .trim()
            ...
            svg: function (t) {
              ...
              if (!(t && this instanceof a.Parent))
                return (
                  ...
                  e.innerHTML.replace(/^<svg>/, "").replace(/<\/svg>INR/, "")
                );
              e.innerHTML =
                "<svg>" +
                t
                  .replace(/\n/, "")
                  .replace(/<([\w:-]+)([^<]+?)\/>/g, "<INR1INR2></INR1>") +
                "</svg>";
        ...
        a(t, [
          {
            ...
            value: function () {
              (this.ctx.publicMethods = [
                ...
                (this.ctx.localization = new INR(this.ctx)),
