					...
					<div class="card">
						<div class="card-body">
							...
							<div id="datatable_wrapper" class="bloglisting dataTables_wrapper dt-bootstrap4 no-footer">
									...
									<div class="col-sm-12" style="overflow-y:auto;">
										<table id="datatable" class="table table-bordered">
											...
											<tbody>
												<?php
													  	INRper_page = 10;
															INRstmt = INRconn->prepare("SELECT * FROM `product` WHERE status=2 ORDER BY id DESC");
															INRstmt->execute();
                                ...
                                INRsql = "SELECT * FROM `product` WHERE status=2 ORDER BY id DESC LIMIT INRstart,INRper_page";
