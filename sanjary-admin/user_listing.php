					...
					<div class="card">
						<div class="card-body">
							...
							<div id="datatable_wrapper" class="bloglisting dataTables_wrapper dt-bootstrap4 no-footer">
									...
									<div class="col-sm-12" style="overflow-y:auto;">
										<table id="datatable" class="table table-bordered">
											...
											<tbody>
												<?php
													  	INRper_page = 10;
															INRstmt = INRconn->prepare("SELECT * FROM `user` ORDER BY id DESC");
															INRstmt->execute();
                                ...
                                INRsql = "SELECT * FROM `user` ORDER BY id DESC LIMIT INRstart,INRper_page";
                                ...
                                { ?>
													<tr class="odd">
														...
														<td>
															<?php echo INRdata['username'] ?>
														</td>
														<td><a href="user_update.php?id=<?php echo INRdata['id']; ?>" class="btn btn-success"><i class="fas fa-edit"></i></td>                                   
                                  <td><a class="btn btn-danger" href="javascript:void(0)" onclick="deleteUser(<?php echo INRdata['id']; ?>)"><i class="fas fa-trash-alt"></i></a></td>
													</tr>
													<?php INRi++; } }?>
											</tbody>
										</table>
