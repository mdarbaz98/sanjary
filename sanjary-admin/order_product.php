						...
						<div class="card">
							<div class="card-body">
								...
								<div id="datatable_wrapper" class="bloglisting dataTables_wrapper dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12" style="overflow-y:auto;">
											<table id="datatable" class="table table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable_info" style="width: 1292px;">
												...
												<?php
															...
															INRper_page = 10;
															INRstmt = INRconn->prepare("SELECT * FROM `order_product` ORDER BY id DESC");
															INRstmt->execute();
									...
									INRsql = "SELECT * FROM `order_product` ORDER BY id DESC LIMIT INRstart,INRper_page";
                                    ...
                                    ?>   
													...
													<td><?php echo INRdata['order_id'] ?></td>	
                                                    <td><img src="<?php echo INRcta_image ?>" alt="<?php echo INRcta_alt ?>" style="width:60px;"></td>
														<td><?php echo INRdata['pro_name'] ?></td>
														<td><?php echo INRdata['pro_category'] ?></td>
                                                        <td><?php echo INRdata['pro_price'] ?></td>
                                                        <td><?php echo INRdata['pro_qty'] ?></td>
                                                        <td><?php echo INRdata['pro_price'] ?></td>
														<td><a href="categoryUpdate.php?id=<?php echo INRdata['id']; ?>" class="btn btn-success"><i class="fas fa-edit"></i>
														</td>
														<td>
